...
gallery/calendar-deprecated/1.0/base
gallery/calendar-deprecated/1.0/page
gallery/calendar-deprecated/1.0/time
gallery/calendar-deprecated/1.0/date
gallery/calendar-deprecated/1.0/index
 ...
 */
KISSY.add('gallery/calendar-deprecated/1.0/base',function (S, Node, Event, undefined) {
 ...
 * @author  拔赤<lijing00333@163.com>
 */
KISSY.add('gallery/calendar-deprecated/1.0/page',function (S, Node, Calendar) {
 ...
 * @author  拔赤<lijing00333@163.com>
 */
KISSY.add('gallery/calendar-deprecated/1.0/time',function(S, Node,Calendar) {
 ...
 * - 简单的本地化，对w（星期x）的支持
 */
KISSY.add('gallery/calendar-deprecated/1.0/date',function (S) {
 ...
 *  calendar
 */
KISSY.add('gallery/calendar-deprecated/1.0/index',function (S, C, Page, Time, Date) {
    C.Date = Date;
    S.Calendar = C;
    return C;
}, {
